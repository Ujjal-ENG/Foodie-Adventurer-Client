...
function OurStory() {
    ...
    return (
        <div className="max-w-screen-xl mx-auto px-4 pb-5 sm:px-6 lg:px-8">
            <div className="py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="order-2 block md:hidden md:order-1">
                    <img src="https://images.pexels.com/photos/3184183/pexels-photo-3184183.jpeg?auto=compress&cs=tinysrgb&w=600" alt="our story" className="rounded-md w-full h-full object-cover" />
                </div>
                <div className="order-2 md:order-1 hidden md:block" data-aos="fade-left" data-aos-duration="1000">
                    <img src="https://images.pexels.com/photos/3184183/pexels-photo-3184183.jpeg?auto=compress&cs=tinysrgb&w=600" alt="our story" className="rounded-md w-full h-full object-cover" />
                </div>
                ...
                <div className="order-1 block md:hidden ">
                    ...
                    <p className="mb-4">
                        ...
                        quality ingredients in our dishes, and we are constantly evolving and adapting to meet the ever-changing tastes and preferences of our customers. Our story is one of growth,
                        innovation, and a commitment to excellence, and we are excited to share it with you.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
                <div className="order-1 block md:hidden ">
                    ...
                    <p className="mb-4">
                        ...
                        satisfying, and we believe that our passion for food shines through in every dish we serve.
                    </p>
                </div>
                ...
                <div className="order-2 block md:hidden ">
                    <img src="https://images.pexels.com/photos/958545/pexels-photo-958545.jpeg?auto=compress&cs=tinysrgb&w=600" alt="passion food" className="rounded-md w-full h-full object-cover" />
                </div>
                <div className="order-2 hidden md:block md:order-2" data-aos="fade-left" data-aos-duration="1000">
                    <img src="https://images.pexels.com/photos/958545/pexels-photo-958545.jpeg?auto=compress&cs=tinysrgb&w=600" alt="passion food" className="rounded-md w-full h-full object-cover" />
                </div>
            </div>
        </div>
